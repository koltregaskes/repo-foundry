...
export const INTERNAL_RUNTIME_ROOT = path.join(WORKSPACE_ROOT, "_local", "surfaces", "repos-hub-internal");
...
export const INTERNAL_CANONICAL_REPO = path.join(WORKSPACE_ROOT, "_My Open Source", "repos-hub");
